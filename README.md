...
| **Claude Code** | Claude 구독에 포함된 CLI 도구 (`npm install -g @anthropic-ai/claude-code`) |
| **Python 3.9+** | PPTX 생성 스크립트 실행용 |

> Claude API 키는 필요하지 않습니다. Claude Pro 이상 구독 요금제로 Claude Code를 사용합니다.
...
| 카테고리 | 기술 |
|---------|------|
| AI | Claude Code (Claude Pro 이상 구독) |
